...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'orderId': typing.Union[OrderIdSchema, decimal.Decimal, int, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _get_order_by_id_mapped_args(
        self,
        order_id: int,
    ...
    async def _aget_order_by_id_oapg(
        self,
...
class GetOrderByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_order_by_id(
        self,
        order_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_order_by_id_mapped_args(
            order_id=order_id,
        )
        return await self._aget_order_by_id_oapg(
...
class GetOrderById(BaseApi):
    ...
    async def aget_order_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_order_by_id(
            order_id=order_id,
            **kwargs,
        )
        if validate:
    ...
    def get_order_by_id(
        ...
        raw_response = self.raw.get_order_by_id(
            order_id=order_id,
        )
        if validate:
            return OrderPydantic(**raw_response.body)
