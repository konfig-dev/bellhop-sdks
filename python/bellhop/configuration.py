...
from bellhop.exceptions_base import ApiValueError
from bellhop.exceptions import ClientConfigurationError
from bellhop.exceptions import InvalidHostConfigurationError
...
conf = bellhop.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://petstore.swagger.io/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("bellhop")
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "") -> None:
