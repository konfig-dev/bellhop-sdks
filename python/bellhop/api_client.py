...
from bellhop import rest
from bellhop.api_response import ApiResponse, AsyncApiResponse
from bellhop.rest import AsyncResponseWrapper, ResponseWrapper
from bellhop.configuration import Configuration
from bellhop.exceptions import ApiTypeError, ApiValueError, MissingRequiredParametersError
from bellhop.request_after_hook import request_after_hook
from bellhop.request_before_url_hook import request_before_url_hook
from bellhop.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __call_api(
        ...
        # Likely that status codes 401 or 403 indicate the need to refresh access token for OAuth
        if response.http_response.status == 401 or response.http_response.status == 403:
