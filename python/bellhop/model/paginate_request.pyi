...
class PaginateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first", "after", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first", "after", ], str]):
