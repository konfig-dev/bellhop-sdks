        ...
        if (e instanceof AxiosError && e.isAxiosError) {
            try {
                const responseBody =
                    ...
                    : e.response?.data
                throw new BellhopError(e, parseIfJson(responseBody))
            } catch (innerError) {
                if (innerError instanceof ReferenceError) {
                    ...
                    throw new BellhopError(e, e.response?.data)
                }
                if (innerError instanceof BellhopError) {
                    // Got "BellhopError" from the above try block
                    throw innerError;
                }
